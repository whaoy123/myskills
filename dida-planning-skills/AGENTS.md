...
- Put deterministic parsing, estimation, dependency, weekly-delivery, merge, and queue logic in `dida-planning-core/scripts`.
...
- No calendar scheduler or execution-block generation. Weekly acceptance does not imply parent completion.
- If no independent reviewer tool is available, report manual/automated review honestly rather than claiming subagent review.
