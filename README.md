...
| [national-instruments-clean-uninstall](national-instruments-clean-uninstall/SKILL.md) | Cleanly remove all NI software, MAX/DAQmx configuration, residual files, and registry entries on Windows, then prepare a minimal cDAQ reinstallation. |
